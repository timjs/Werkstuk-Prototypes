...
\begin{description}
  ...
  %
  \item[Argumenten] De argumenten van een functie worden gerepresenteerd door een lijst elementen uit \Id. In het programma zelf worden de argumenten nog gerepresenteerd door een element uit \MaybeIds. We definiëren daarom de triviale functie $\textsc{Ids} : \MaybeIds \to \Id_{\langle\rangle}$ op de volgende manier:
  \begin{align*}
