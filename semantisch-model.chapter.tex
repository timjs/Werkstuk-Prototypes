...
% T: Dan moeten we dit verplaatsen naar boven.
...
In sectie \ref{sec:voorbeelden} is informeel gebleken dat scopes conceptueel goed te zien zijn als een boomstructuur. Stel we evalueren een variabele \I{x} in scope $s$:
...
dan kunnen we dit als volgt uitleggen. Eerst zoeken we \I{x} op in de bindingen groep $b_s$, behorende bij scope $s$.
\begin{equation*}
  b_s(x).
\end{equation*}
