% (geen punt, ik was met \setsansfont te klooien, en die veranderde de titels steeds niet, toen kwam ik erachter waar ze eigenlijk vandaan kwamen -- beetje vergezocht i know..)
% T: Ik heb nu netjes de koppen in Biolinum gezet, het schreefloze broertje van Libertine.
\documentclass
  [11pt,a4paper,
   twoside=true,
   parskip=half,
...
\renewcommand{\extraVskip}
  {4pt} % Iets meer verticale ruimte
...
\newcommand{\Config}[2]
  {\ensuremath{\SurrAngle{#1}_{#2}}}%  -- <<S>>m,s,t
...
%TODO: Gebruiken we dit bij Bussproof?
